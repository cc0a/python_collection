...
label.grid(column=0, columnspan=3)
...
fileList.config(border=3, relief='sunken')
...
rbValue.set(1)  # default radio button selected is button 1 AKA Filename in this instance
# Radio Buttons
...
# Date spinners
daySpin = tkinter.Spinbox(dateFrame, width=5, from_=1, to=31)  # from_ <--- NOTE THE UNDERSCORE!
