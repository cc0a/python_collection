...
class Artist:
    ...
    def add_song(self, name, year, title):
        ...
        This method is going to add a song to an album in the collection.
        The new album will be created in the album if it doesn't already exist.

        Args:
            name(str): Name of the album
            year(int): The year the album was released
            title(str): Totle of the song
        """
